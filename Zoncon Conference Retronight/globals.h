...
static NSString *SHARE_MSG = @"ZonCon Conference Retronight App";
static NSString *SHARE_SUBJECT = @"ZonCon Conference Retronight App";
static NSString *SHARE_CONTENT = @"Thank you for downoading the ZonCon Conference App!";
static NSString *FEEDBACK_EMAIL_SUBJECT = @"ZonCon Conference Retronight App Feedback";
